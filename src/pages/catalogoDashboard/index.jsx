...
const CatalogoDashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const respuesta = await triggerFetch("https://modisteria-back-production.up.railway.app/api/catalogos/getAllCatalogo", "GET");
    ...
    const confirmDelete = async () => {
        try {
            ...
            if (response.status === 200 || response.status === 201) {
                ...
                alert("Error inesperado al eliminar el producto. Revisa la consola para más información.");
            }
        } catch (error) {
            console.error("Error al realizar la solicitud:", error);
    ...
    const columns = [
        ...
        { field: "precio", headerName: "Precio", type: "number", headerAlign: "left", align: "left" },
