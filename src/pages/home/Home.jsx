...
export default function Home() {
  ...
  const posts = [
    {
      title: "Bienvenido a Modisteria Doña Luz. Si aún no tienes una cuenta, puedes Registrarte",
    ...
    {
      title: "Si ya habias ingresado a Modisteria Doña Luz, puedes Iniciar Sesión y hacer uso de nuestros servicios",
    ...
    {
      title: "Si deseas ver una muestra de nuestros servicios, puedes ver las prendas disponibles en nuestro catálogo",
                ...
                <a className="main-post__link" href={post.link}>
                  ...
                  {post.type === "article" ? (
                    ...
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <circle cx="10" cy="10" r="9" stroke="#C20000" strokeWidth="2" />
